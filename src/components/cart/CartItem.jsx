          ...
          <div className="grid items-center gap-4">
            ...
            <div className="flex items-center justify-around w-full">
              <button
                ...
                type="button"
                className="bg-theme-cart rounded w-6 h-6 lg:w-5 lg:h-5 flex 
              ...
              font-medium lg:text-xs w-7 h-6 lg:w-6 lg:h-5
        ...
        <div className="grid items-center gap-5">
          ...
          <div className="grid items-center justify-center">
            <button
              ...
              type="button"
              className="bg-theme-cart rounded text-white p-1 lg:p-0.5 
